...
def investing_example():
    ...
    statsmodels_args_inv = StatsModelsSettings(3, True)
    quandl_args_inv = QuandlSettings(10, 4, "yearly")

    regressions_inv = [
                       RegressionAnalysis("NSE/ABB", quandl_args_inv, statsmodels_args_inv, 'g')]
